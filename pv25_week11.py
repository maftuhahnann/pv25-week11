...
class BookInventoryApp(QMainWindow):
    def __init__(self):
        ...
        self.student_label = QLabel("<b>Nama: Maftuh Ahnan Al-Kautsar | NIM: F1D022135</b>")
        self.student_label.setAlignment(Qt.AlignCenter)
        self.student_label.setStyleSheet("margin: 10px;")
        ...
        self.save_button.setStyleSheet(green_style)
        self.paste_button.setStyleSheet(blue_style)
        ...
        self.delete_button.setStyleSheet(red_style)
        self.delete_button.clicked.connect(self.delete_book)

        self.export_button = QPushButton("Ekspor")
        self.export_button.setStyleSheet(orange_style)
...
NIM : F1D022135
    ...
    def delete_book(self):
        ...
        reply = QMessageBox.question(self, 'Konfirmasi Hapus', 'Apakah Anda yakin ingin menghapus data ini?',
